...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn('px-8 py-6 text-sm font-semibold text-slate-900 dark:text-slate-300', inset && 'pl-32', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator ref={ref} className={cn('-mx-4 my-4 h-px bg-slate-100 dark:bg-slate-700', className)} {...props} />
))

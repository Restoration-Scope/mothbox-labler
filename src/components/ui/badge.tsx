...
const badgeVariants = cva('inline-flex items-center grow-0 rounded-sm font-medium ring-1 ring-inset ring-[rgba(0,0,0,0.03)]', {
  variants: {
    variant: {
      ...
      warn: 'bg-amber-400/20 !text-amber-700',
      ...
      lime: 'bg-lime-400/20 !text-lime-700',
      green: 'bg-green-500/15 !text-green-700 ring-green-700/15',
      ...
      blue: 'bg-blue-500/15 !text-blue-700 ring-blue-700/15',
